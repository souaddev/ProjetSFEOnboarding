...
@Component({
  selector: 'app-list-employe-manager',
  templateUrl: './list-employe-manager.component.html',
  styleUrls: ['./list-employe-manager.component.css'],
  encapsulation: ViewEncapsulation.None,

  providers: [{ provide: AlertConfig, useFactory: getAlertConfig }]
})
export class ListEmployeManagerComponent implements OnInit {
  ...
  listEmployeByManager(manager){
    this.userService.getEmployesByManager(manager).subscribe((users)=>{
      console.log(users);
      this.users=users;
      this.service=this.users[0].equipe.service;
    },(error)=>{
      console.log(error);
    })
  }
